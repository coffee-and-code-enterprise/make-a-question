	...
	return (
		<main className={styles.heroContainer}>
			...
			<section className={styles.team}>
				<h1 className={styles.teamTitle}> Integrantes da Equipe</h1>
				<div className={styles.firstProfiles}><div><p>"The Man"</p>
				...
				<div className={styles.secondProfiles}><div><p>"Cazé"</p>
				<p>GUSTAVO HENRIQUE</p>
				<img className={styles.gus} src="/about/gus.png" alt="" />
				<p>° 17 anos</p>
				<p>° gustavvohenrique58@gmail.com</p></div>
				
				<div><p>"Vini-Conquista"</p>
				<p>VINÍCIUS SANTIAGO</p>
				<img className={styles.vini} src="/about/vini.png" alt="" />
				<p>° 17 anos</p>
				<p>°viniciusduartesant@gmail.com</p></div></div>
